...
import logoHorizontal from '@/assets/logo-horizontal-02.png';
import dashboardPreview from '@/assets/crm-interface.png';
      ...
      <div className="container mx-auto px-4 pt-20 pb-16 lg:pt-0">
        <nav className="absolute top-0 left-0 right-0 z-50 py-6 px-4">
          <div className="container mx-auto flex items-center justify-between">
            <img src={logoHorizontal} alt="FirstLine AI" className="h-12 w-auto" />
            <a
              href="#lead-form"
